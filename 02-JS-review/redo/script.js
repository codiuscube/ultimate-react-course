...
const newBook = {
  id: 6,
  title: "A A Harry Potter and the Chamber of Secrets",
  author: "J.K. Rowling",
};

const booksAfterAdd = [...books, newBook]
  .slice()
  .map((book) => ({ title: book.title, id: book.id, pages: book.pages }))
...
const booksAfterUpdate = booksAfterDelete
  .slice()
  .map((book) => (book.id === 1 ? { ...book, pages: 12100000 } : book));
