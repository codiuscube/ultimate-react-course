...
// Print J.K. Rowling variable
const rowlingAuthor = books.find((book) => book.id === 4);
rowlingAuthor;
...
const newBook = {
  ...
  author: rowlingAuthor ? rowlingAuthor?.author : "Unknown Author",
};
